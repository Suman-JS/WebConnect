...
const ErrorPage = ({ statusCode }) => {
	return (
		<div className="Container">
			...
			<h1 className="MainTitle">An error has occurred</h1>
			<p className="Main Description">
				Server is currently under high load - please hit <code>reload</code> on
				your browser in a minute to try again or contact support.
			</p>
		</div>
	);
};
